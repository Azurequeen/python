...
from keras.layers import Input, Conv3D, MaxPooling3D, UpSampling3D, Activation, Reshape, core,normalization,concatenate,add,Cropping3D,Dropout
...
def ConvNet48(ch):
    conv1 = Conv3D(64, (3, 3, 3), padding='valid',activation='relu')(ch)
    #conv1 = Dropout(0.2)(conv1)    
    conv2 = Conv3D(64, (3, 3, 3), padding='valid')(conv1)
    ...
    conv4 = Conv3D(64, (3, 3, 3), padding='valid')(conv3)
    ...
    conv6 = Conv3D(64, (3, 3, 3), padding='valid')(conv5)
    ...
    conv7 = Conv3D(256, (5, 5, 5), padding='valid',activation='relu')(conv6)
...
def ConvNet32(ch): 
    ...
    conv9 = Conv3D(256, (6, 6, 6), padding='valid',activation='relu')(conv8)
    #conv10 = Conv3D(2,(1,1,1), padding='same',activation='relu')(conv9)
    return conv9
def ConvNet16(ch):   
    ...
    conv10=Conv3D(256, (6, 6, 6), padding='valid',activation='relu')(conv9)
    #conv11 = Conv3D(2,(1,1,1), padding='same',activation='relu')(conv10)
    return conv10
def ClassNet_MultiScale():
    ...
    fusion=Conv3D(2,(1,1,1), padding='same',activation='relu')(fusion)
...
def ClassNet_FlexWindow():
    ...
    act=Activation('softmax')(a)
    model = Model(inputs=inputs, outputs=act)
    model.compile(optimizer=Adam(lr=config["initial_learning_rate"]), loss='categorical_crossentropy',metrics=['categorical_accuracy'])#'mean_squared_error',metrics=['accuracy'])
    return model