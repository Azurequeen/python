...
'model_val_pred' : main_path + 'Data/train_mask/val_pred/',    
'model_test_pred' : main_path + 'Data/train_mask/test_pred/',
    
#送入分类模型的数据存放目录
'cls_path' : main_path + 'Data/train_cls/',   
    

'cls_train_cube_30' : main_path + 'Data/train_cls_cube_36/train/',  
'cls_test_cube_30' : main_path + 'Data/train_cls_cube_36/test/',     
'cls_train_cube_30_true' : main_path + 'Data/train_cls_cube_36/train/true/', 
'cls_train_cube_30_false' : main_path + 'Data/train_cls_cube_36/train/false/',      
'cls_test_cube_30_true' : main_path + 'Data/train_cls_cube_36/test/true/', 
'cls_test_cube_30_false' : main_path + 'Data/train_cls_cube_36/test/false/', 
    
    
#分割、分类模型目录
'model_paths' : main_path + 'Data/model/',
'model_final' : main_path + 'Data/model/final_model/',
}
