...
def dir_check(luna_path):
    if os.path.isdir(luna_path + 'Data/nodules_2d/'):
        pass
    else:
        os.mkdir(luna_path + 'Data/nodules_2d/')

    if os.path.isdir(luna_path + 'Data/nodules_2d/lung_mask/'):
        pass
    else:
        os.mkdir(luna_path + 'Data/nodules_2d/lung_mask/')

    if os.path.isdir(luna_path + 'Data/nodules_2d/nodule_mask/'):
        pass
    else:
        os.mkdir(luna_path + 'Data/nodules_2d/nodule_mask/')
...
def unet_fit(name, batch_size, unet_model, load_check=False, check_name=None):
    ...
    model.fit_generator(generate_train(lung_path, nodule_path, start_t, end_t, batch_size), epochs=3, verbose=1,
