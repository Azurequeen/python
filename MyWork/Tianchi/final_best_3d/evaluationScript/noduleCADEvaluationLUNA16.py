...
if __name__ == '__main__':
    ...
    noduleCADEvaluation('/Volumes/solo/ali/evaluationScript/annotations/annotations_all.csv',
                        '/Volumes/solo/ali/evaluationScript/annotations/annotations_excluded.csv',
                        '/Volumes/solo/ali/evaluationScript/annotations/seriesuids.csv',
                        '/Volumes/solo/ali/evaluationScript/exampleFiles/val_cal_2.csv',
                        '/Volumes/solo/ali/evaluationScript/')
    print "Finished!"
