...
def make_pos_annotation_images():
    src_dir = "/Volumes/solo/ali/pic/luna16_extracted_images/_labels/"
    ...
    for patient_index, csv_file in enumerate(glob.glob(src_dir + "*_annos_pos.csv")):
        ...
        if len(df_annos) == 0:
            continue
        images = helpers.load_patient_images(patient_id, "/Volumes/solo/ali/pic/luna16_extracted_images/", "*" + CUBE_IMGTYPE_SRC + ".png")
